...
public class ChargingMeleeEnemy : Enemy
{
    ...
    public override void UpdateEntity()
    {
        ...
        if (Vector2.Distance(gameObject.transform.position, player.transform.position) < 0.75 * dashAbility.GetDashingDistance() && !RaycastContainsWall(rays) && dashAbility.dashingState == DashAbility.DashingState.Ready)
        {
